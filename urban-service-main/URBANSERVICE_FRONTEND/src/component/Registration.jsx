            ...
            <div className="row justify-content-center">
              <div className="col-md-6">
                <div className="card text-center shadow-card rounded ">
                  <div className="card-header bg-gradient-dark rounded text-white">
                  ...
                  <div className="card-body bg-cover">
                    ...
                    <div className="mt-4">
                      <Link
                        ...
                        className="btn btn-lg hover-effect btn-dribbble me-3 bg-gradient-dark"
                      >
                        Serviceprovider
                      </Link>
                      <Link
                        to="/user/registration"
                        className="btn  btn-lg hover-effect btn-dribbble bg-gradient-dark"
                      >
                        User
                      </Link>
                    </div>
                  </div>
                  <div className="card-footer text-white text-center bg-gradient-dark rounded">
