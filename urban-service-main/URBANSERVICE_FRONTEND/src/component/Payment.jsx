...
const CheckoutForm = ({ id }) => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const { data } = await axios.post("http://localhost:4000/payments/charge", {
        paymentMethodId: paymentMethod.id,
        userId,
        amount: 5000, // Example amount (modify as needed)
        currency: "usd",
        bookingId: id,
      });
  ...
  return (
    <>
      ...
      <div className="container mt-5">
        ...
        <span>Please make the payment to proceed.</span>
